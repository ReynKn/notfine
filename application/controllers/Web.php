...
class Web extends CI_Controller
{
    ...
    public function customer_save()
    {
        ...
        $data['customer_whatsapp'] = $this->input->post('customer_whatsapp');
        ...
        $this->form_validation->set_rules('customer_whatsapp', 'Customer Whatsapp', 'trim|required|[tbl_customer.customer_whatsapp]');
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($result) {
                ...
                $this->session->set_flashdata('customer_whatsapp', $data['customer_whatsapp']);
    ...
    public function customer_logincheck()
    {
        ...
        $this->form_validation->set_rules('customer_whatsapp', 'Customer Whatsapp', 'trim|required');
        $this->form_validation->set_rules('customer_password', 'Customer Password', 'trim|required');
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($result) {
                ...
                $this->session->set_userdata('customer_whatsapp', $data['customer_whatsapp']);
                redirect('/');
            } else {
    ...
    public function customer_shipping_login()
    {
        ...
        $this->form_validation->set_rules('customer_whatsapp', 'Customer Whatsapp', 'trim|required|valid_email');
        $this->form_validation->set_rules('customer_password', 'Customer Password', 'trim|required');
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($result) {
                $this->session->set_userdata('customer_id', $result->customer_id);
                $this->session->set_userdata('customer_whatsapp', $result->customer_whatsapp);
    ...
    public function save_shipping_address()
    {
        ...
        $data['shipping_whatsapp'] = $this->input->post('shipping_whatsapp');
        ...
        $this->form_validation->set_rules('shipping_whatsapp', 'Shipping Whatsapp', 'trim|required|[tbl_shipping.shipping_whatsapp]');
    ...
    public function logout()
    {
        ...
        $this->session->unset_userdata('customer_whatsapp');
        redirect('customer/login');
    }
