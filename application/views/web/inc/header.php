            ...
            <div class="header_top_right">
                <div class="search_box">
                    <form method="get" action="<?php echo base_url('search') ?>">
                        ...
                        <input type="submit" value="SEARCH" style="background-color: pristine-blue; color: white;">
                    </form>
                </div>
        ...
        <div class="menu">
            <ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
                <li class="<?php
                            ...
                            ?>"><a href="<?php echo base_url('/'); ?>" style="background-color: pristine-blue; color: white; ">Home</a></li>
                <li class=" <?php
