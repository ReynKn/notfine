            ...
            <form class="user" method="POST" action="<?= base_url('Auth/registrasi'); ?>">
              ...
              <div class="form-check form-check-info text-start" style="color: lightskyblue;">
                ...
                <label class="form-check-label " for="flexCheckDefault">
                  I agree the <a href="javascript:;" class=" font-weight-bolder text-primary text-gradient font-weight-bold" style="color: lightskyblue;">Terms and Conditions</a>
                </label>
              </div>
              <div class="text-center">
                <button type="" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Sign In</button>
              </div>
              <p class="text-sm mt-3 mb-0">Already have an Account?<a href="<?= base_url('Auth'); ?>" class="font-weight-bolder text-primary text-gradient font-weight-bold"> Login!</a></p>
            </form>
          </div>
        </div>
      </div>
